...
| <kbd>E</kbd> | Engine sound on/off | Off |
| <kbd>P</kbd> | Pause | — |
...
| Pack | Highlights |
|:-----|:-----------|
| **Classic** | Amiga divisions, easiest first: **4** Little Ramp · Hump Back · **3** Stepping Stones · Big Ramp · **2** High Jump · Roller Coaster · **1** Ski Jump · Draw Bridge |
